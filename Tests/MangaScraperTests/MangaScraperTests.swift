...
final class MangaScraperTests: XCTestCase {
    func testExample() async throws {
        ...
        do {
            // https://api.mangadex.org/chapter?manga=248525ed-ad1c-4ddc-a834-5d6ce66a3ad2&ids[]=329e7b26-a615-4d4a-bf53-856f60d5833f
            let d = try await MangaDex.shared.fetchChapterImages(mangaId: "b1461071-bfbb-43e7-a5b6-a7ba5904649f", chapterId: "329e7b26-a615-4d4a-bf53-856f60d5833f")
            print(d)
        } catch {
            print(error)
        }
